"""Initial migration: Create all tables for Edusched

Revision ID: 69174d2c9756
Revises: None
Create Date: 2025-09-24 16:19:23
...
def upgrade() -> None:
    ...
    # Skip manual enum creation to avoid conflicts
    ...
    op.create_table(
        ...
        sa.Column('result_metadata', sa.JSON(), nullable=False, default=dict),
    ...
    op.bulk_insert(op.table('alembic_version'), [{'version_num': '69174d2c9756'}])
